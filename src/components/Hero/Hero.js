...
const Hero = () => {
    ...
    const [hasSearched, setHasSearched] = useState(false); // Stare pentru a urmări dacă s-a efectuat o căutare
    ...
    const fetchData = async (value) => {
        try {
            setHasSearched(true); // Marchează căutarea ca efectuată
            ...
            setResults(filteredResults.length === 0 && value ? [] : filteredResults);
        } catch (error) {
